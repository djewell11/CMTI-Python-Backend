...
class ID_Manager:
  ...
  def __init__(self):
    ...
    self.BC = ProvID('BC')
    self.all_ids.append(self.BC)
    self.MN = ProvID('MN')
    self.all_ids.append(self.MN)
    self.NB = ProvID('NB')
    self.all_ids.append(self.NB)
    self.NL = ProvID('NL')
    self.all_ids.append(self.NL)
    self.NS = ProvID('NS')
    self.all_ids.append(self.NS)
    self.ON = ProvID('ON')
    self.all_ids.append(self.ON)
    self.PE = ProvID('PE')
    self.all_ids.append(self.PE)
    self.QC = ProvID('QC')
    self.all_ids.append(self.QC)
    self.SK = ProvID('SK')
    self.all_ids.append(self.SK)
    self.NT = ProvID('NT')
    self.all_ids.append(self.NT)
    self.NU = ProvID('NU')
